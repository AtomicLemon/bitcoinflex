...
[Translation Process](https://github.com/bitcoinflex-project/bitcoinflex/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitcoinFlex Core project, and is not to be
confused with overall BitcoinFlex Network Protocol consensus changes.
...
Where a patchset proposes to change the BitcoinFlex consensus, it must have been
