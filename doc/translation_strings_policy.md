...
This document provides guidelines for internationalization of the BitcoinFlex Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinflex_en.ts` remains unchanged.
