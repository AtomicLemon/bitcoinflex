...
- [Development guidelines](#development-guidelines)
    - [General BitcoinFlex Core](#general-bitcoinflex-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
BitcoinFlex Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Run with the `-testnet` option to run with "play BCXs (tBCX)" on the test network, if you
...
BitcoinFlex Core is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/bitcoinflex-project/bitcoinflex/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates BCXs (if wallet is enabled).
...
file descriptors it will cause problems with BitcoinFlex's `select()` loop, because
