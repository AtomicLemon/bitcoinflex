...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcoinflex-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcoinflex-cli.cpp \
           src/bitcoinflex-tx.cpp \
           src/bitcoinflex.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/bitcoinflex.qrc src/qt/bitcoinflex_locale.qrc

TRANSLATIONS += src/qt/locale/bitcoinflex_bg.ts \
                src/qt/locale/bitcoinflex_de.ts \
                src/qt/locale/bitcoinflex_en.ts \
                src/qt/locale/bitcoinflex_es.ts \
                src/qt/locale/bitcoinflex_fi.ts \
                src/qt/locale/bitcoinflex_fr.ts \
                src/qt/locale/bitcoinflex_it.ts \
                src/qt/locale/bitcoinflex_ja.ts \
                src/qt/locale/bitcoinflex_pl.ts \
                src/qt/locale/bitcoinflex_pt.ts \
                src/qt/locale/bitcoinflex_ru.ts \
                src/qt/locale/bitcoinflex_sk.ts \
                src/qt/locale/bitcoinflex_sv.ts \
                src/qt/locale/bitcoinflex_vi.ts \
                src/qt/locale/bitcoinflex_zh_CN.ts \
                src/qt/locale/bitcoinflex_zh_TW.ts
