...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinFlex features */
        {"bitcoinflex", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinflex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinflex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinflex", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcoinflex", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcoinflex", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcoinflex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinflex", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinflex", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinflex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinflex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinflex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinflex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinflex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinflex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinflex", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinflex", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinflex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinflex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinflex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinflex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinflex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinflex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinflex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinflex", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinflex", "mnsync", &mnsync, true, true, false},
        {"bitcoinflex", "spork", &spork, true, true, false},
        {"bitcoinflex", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbcxseed", &getzbcxseed, false, false, true},
        {"zerocoin", "setzbcxseed", &setzbcxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbcx", &searchdzbcx, false, false, true},
        {"zerocoin", "dzbcxstate", &dzbcxstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17667/\n";
}
