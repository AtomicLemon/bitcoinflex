...
#ifndef BitcoinFlex_ZBCXWALLET_H
#define BitcoinFlex_ZBCXWALLET_H
...
public:
    CzBCXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBCX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBCX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BitcoinFlex_ZBCXWALLET_H
