...
#ifndef BitcoinFlex_ZBCXTRACKER_H
#define BitcoinFlex_ZBCXTRACKER_H
...
public:
    CzBCXTracker(std::string strWalletFile);
    ~CzBCXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBCXWallet* zBCXWallet = NULL);
...
#endif //BitcoinFlex_ZBCXTRACKER_H
