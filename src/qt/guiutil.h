...
/** Utility functions used by the BitcoinFlex Qt UI.
 */
namespace GUIUtil
{
...
// Render BitcoinFlex addresses in monospace font
...
// Parse "bitcoinflex:" URI into recipient object, return true on successful parsing
