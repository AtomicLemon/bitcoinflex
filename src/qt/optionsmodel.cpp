...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BCX);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitcoinFlexAmount"))
        SoftSetArg("-anonymizebitcoinflexamount", settings.value("nAnonymizeBitcoinFlexAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitcoinflex.cpp during shotdown to also remove the window positions
