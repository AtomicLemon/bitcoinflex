...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinFlex Core"),
     ...
     * override -datadir in the bitcoinflex.conf file in the default data directory
     * (to be consistent with bitcoinflexd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
