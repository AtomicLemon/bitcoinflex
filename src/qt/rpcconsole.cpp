                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBCXPathCustom = GetArg("-zbcxbackuppath", "");
    ...
    if(!strzBCXPathCustom.empty()) {
        ui->wallet_customzbcxbackuppath->setText(QString::fromStdString(strzBCXPathCustom));
        ui->wallet_customzbcxbackuppath_label->setVisible(true);
        ui->wallet_customzbcxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBCXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitcoinFlex RPC console.") + "<br>" +
